...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i12.FetchFavoriteAuthorsUseCaseImpl>(
        () => _i12.FetchFavoriteAuthorsUseCaseImpl(gh<_i9.AuthorRepository>()));
    gh.factory<_i13.FetchFavoriteBooksUseCaseImpl>(
        () => _i13.FetchFavoriteBooksUseCaseImpl(gh<_i10.BookRepository>()));
    gh.factory<_i14.FetchUserImageUseCaseImpl>(
        () => _i14.FetchUserImageUseCaseImpl(gh<_i8.UserRepository>()));
    gh.factory<_i11.FetchAllBooksUseCase>(() => bookModule
        .getFetchAllBooksUseCase(gh<_i11.FetchAllBooksUseCaseImpl>()));
    gh.factory<_i12.FetchFavoriteAuthorsUseCase>(() =>
        authorsModule.getFetchFavoriteAuthorsUseCase(
            gh<_i12.FetchFavoriteAuthorsUseCaseImpl>()));
    gh.factory<_i13.FetchFavoriteBooksUseCase>(() =>
        bookModule.getFetchFavoriteBooksUseCase(
            gh<_i13.FetchFavoriteBooksUseCaseImpl>()));
    gh.factory<_i14.FetchUserImageUseCase>(() => userModule
        .getFetchUserImageUseCase(gh<_i14.FetchUserImageUseCaseImpl>()));
    return this;
  }
}

class _$GraphQlDataSourceBindings extends _i15.GraphQlDataSourceBindings {}

class _$UserModule extends _i16.UserModule {}
